...
test('test case C214: Verify that all elements on the footer are displayed and all links are clickable', async ({ page }) => {
    ...
    await tendersPage.checkUrl(pagesUrlPath["tenders-map"]);
...
test.only('test case C226: Verify "У Вас залишилися питання?" form', async ({ page }) => {
